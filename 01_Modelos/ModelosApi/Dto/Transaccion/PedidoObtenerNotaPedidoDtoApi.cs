...
{
    public class PedidoObtenerNotaPedidoDtoApi
    {
        ...
        public List<PedidoAtributoDetalleDtoApi> ListaDetalle { get; set; }
        public PedidoObtenerNotaPedidoDtoApi()
        {
            ListaDetalle = new List<PedidoAtributoDetalleDtoApi>();
        }
    }
}
