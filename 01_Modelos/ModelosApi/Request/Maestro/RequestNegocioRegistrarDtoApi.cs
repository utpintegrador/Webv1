...
{
    public class RequestNegocioRegistrarDtoApi
    {
        ...
        public List<RequestNegocioRegistrarUbicacionRegistrarDtoApi> ListaUbicacion { get; set; }

        public RequestNegocioRegistrarDtoApi()
        {
            ListaUbicacion = new List<RequestNegocioRegistrarUbicacionRegistrarDtoApi>();
        }
