...
{
    public class RequestPedidoModificarDtoApi
    {
        ...
        public List<RequestPedidoModificarPedidoDetalleModificarDtoApi> ListaPedidoDetalle { get; set; }

        public RequestPedidoModificarDtoApi()
        {
            ListaPedidoDetalle = new List<RequestPedidoModificarPedidoDetalleModificarDtoApi>();
        }
    }
}
