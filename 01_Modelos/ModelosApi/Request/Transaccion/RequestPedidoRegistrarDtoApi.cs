...
{
    public class RequestPedidoRegistrarDtoApi
    {
        ...
        public List<RequestPedidoRegistrarPedidoDetalleRegistrarDtoApi> ListaPedidoDetalle { get; set; }

        public RequestPedidoRegistrarDtoApi()
        {
            ListaPedidoDetalle = new List<RequestPedidoRegistrarPedidoDetalleRegistrarDtoApi>();
        }
    }
}
