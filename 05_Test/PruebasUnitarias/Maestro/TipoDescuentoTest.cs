...
namespace PruebasUnitarias.Maestro
{
    public class TipoDescuentoTest
    {
        ...
        [Test]
        public void TipoDescuento_Registrar()
        {
            var request = new ModelosApi.Request.Maestro.RequestTipoDescuentoRegistrarDtoApi();
        ...
        [Test]
        public void TipoDescuento_Modificar()
        {
            var request = new ModelosApi.Request.Maestro.RequestTipoDescuentoModificarDtoApi();
