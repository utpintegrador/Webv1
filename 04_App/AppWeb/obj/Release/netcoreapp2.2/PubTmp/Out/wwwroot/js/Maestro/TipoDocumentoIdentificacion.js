...
$(document).ready(function () {
    ...
    ProcesarCargaDeTipoDocumentoIdentificacion();
});

function ProcesarCargaDeTipoDocumentoIdentificacion() {
...
function CargarData() {
    ...
    tb1 = $('#tb1').DataTable({
        ...
        "ajax": {
            "url": "../../TipoDocumentoIdentificacion/ObtenerData",
            "type": "POST",
            "datatype": "json",
            "data": function (d) {
...
function ObtenerConfiguracionColumnas() {
    ...
    return [
        ...
        { "data": "IdTipoDocumentoIdentificacion", "name": "IdTipoDocumentoIdentificacion", "visible": false },
        ...
        swalWithBootstrapButtons.fire({
            ...
            switch (respuesta.value) {
                case true:
                    ...
                    EliminarRegistro(fila.IdTipoDocumentoIdentificacion);
                    break;
                default:
...
function EliminarRegistro(id) {
    ...
    $.ajax({
        'url': '../../TipoDocumentoIdentificacion/Eliminar',
        'type': 'POST',
        'data': prm,
        'dataType': 'json',
        beforeSend: function () {
...
$(document).on('click', '#tb1 tbody #btnEditar', function () {
    var fila = tb1.row($(this).parents('tr')).data();
    if (fila !== null) {
        window.location.href = '/TipoDocumentoIdentificacion/Edit/' + fila.IdTipoDocumentoIdentificacion;
    }
});
...
//$(document).on('change', '#cboTipoDocumentoIdentificacion', function (e) {
//    RecargarData();
//});
