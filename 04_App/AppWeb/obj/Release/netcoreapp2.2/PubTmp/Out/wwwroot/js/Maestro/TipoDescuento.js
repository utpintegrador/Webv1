...
$(document).ready(function () {
    ...
    ProcesarCargaDeTipoDescuento();
});

function ProcesarCargaDeTipoDescuento() {
...
function ObtenerConfiguracionColumnas() {
    ...
    return [
        ...
        { "data": "IdTipoDescuento", "name": "IdTipoDescuento", "visible": false },
        ...
        swalWithBootstrapButtons.fire({
            ...
            switch (respuesta.value) {
                case true:
                    ...
                    EliminarRegistro(fila.IdTipoDescuento);
                    break;
                default:
...
$(document).on('click', '#tb1 tbody #btnEditar', function () {
    var fila = tb1.row($(this).parents('tr')).data();
    if (fila !== null) {
        window.location.href = '/TipoDescuento/Edit/' + fila.IdTipoDescuento;
    }
});
...
//$(document).on('change', '#cboTipoDescuento', function (e) {
//    RecargarData();
//});
