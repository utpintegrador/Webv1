...
$(document).ready(function () {
    ...
    ProcesarCargaDeTipoEstado();
});

function ProcesarCargaDeTipoEstado() {
...
function ObtenerConfiguracionColumnas() {
    ...
    return [
        ...
        { "data": "IdTipoEstado", "name": "IdTipoEstado", "visible": false },
        ...
        swalWithBootstrapButtons.fire({
            ...
            switch (respuesta.value) {
                case true:
                    ...
                    EliminarRegistro(fila.IdTipoEstado);
                    break;
                default:
...
$(document).on('click', '#tb1 tbody #btnEditar', function () {
    var fila = tb1.row($(this).parents('tr')).data();
    if (fila !== null) {
        window.location.href = '/TipoEstado/Edit/' + fila.IdTipoEstado;
    }
});
...
//$(document).on('change', '#cboTipoEstado', function (e) {
//    RecargarData();
//});
