...
$(document).ready(function () {
    ...
    window._idTipoUsuario = ObtenerParametroUrl();

    $.when(ObtenerPorId(window._idTipoUsuario))
...
function Actualizar() {
    ...
    var prm = {
        'IdTipoUsuario': window._idTipoUsuario,
        'Descripcion': $("#txtDescripcion").val()
    };

    $.ajax({
        'url': '../../TipoUsuario/Modificar',
        'type': 'POST',
        'data': prm,
        'dataType': 'json',
        headers: {
