...
$(document).ready(function () {
    ...
    ProcesarCargaDeTipoUsuario();
});

function ProcesarCargaDeTipoUsuario() {
...
function ObtenerConfiguracionColumnas() {
    ...
    return [
        ...
        { "data": "IdTipoUsuario", "name": "IdTipoUsuario", "visible": false },
        ...
        swalWithBootstrapButtons.fire({
            ...
            switch (respuesta.value) {
                case true:
                    ...
                    EliminarRegistro(fila.IdTipoUsuario);
                    break;
                default:
...
$(document).on('click', '#tb1 tbody #btnEditar', function () {
    var fila = tb1.row($(this).parents('tr')).data();
    if (fila !== null) {
        window.location.href = '/TipoUsuario/Edit/' + fila.IdTipoUsuario;
    }
});
