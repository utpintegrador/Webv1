...
$(document).ready(function () {
    ...
    window._idTipoEstado = ObtenerParametroUrl();

    $.when(ObtenerPorId(window._idTipoEstado))
...
function Actualizar() {
    ...
    var prm = {
        'IdTipoEstado': window._idTipoEstado,
        'Descripcion': $("#txtDescripcion").val()
    };

    $.ajax({
        'url': '../../TipoEstado/Modificar',
        'type': 'POST',
        'data': prm,
        'dataType': 'json',
        headers: {
