...
$(document).ready(function () {
    ...
    window._idTipoBusqueda = ObtenerParametroUrl();

    $.when(ObtenerPorId(window._idTipoBusqueda))
...
function Actualizar() {
    ...
    var prm = {
        'IdTipoBusqueda': window._idTipoBusqueda,
        'Descripcion': $("#txtDescripcion").val()
    };

    $.ajax({
        'url': '../../TipoBusqueda/Modificar',
        'type': 'POST',
        'data': prm,
        'dataType': 'json',
        headers: {
